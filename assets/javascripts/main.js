...
$(function () {
  ...
  var Projects = {
    ...
    filterCard: function (index, card) {
      ...
      var keep = this.cardContainsAllFilters(cardData, this.filters)
      $card.toggle(keep)
    },
    ...
    cardContainsAllFilters: function (cardData, filters) {
  ...
  var App = {
    ...
    registerHelpers: function () {
      Handlebars.registerHelper('wrap', function (value) {
